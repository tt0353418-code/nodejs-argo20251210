...
const UUID = process.env.UUID || 'c9e35fd8-36d3-483a-ac73-d4a64f5eba67'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';        // 哪吒v1填写形式: nz.abc.com:8008  哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';            // 使用哪吒v1请留空，哪吒v0需填写
const NEZHA_KEY = process.env.NEZHA_KEY || '';              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || '20151210.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMzQ5Zjc0NTc1ZWJkZTQ2MzIwMTljODI1NmMxOWJjM2EiLCJ0IjoiODk5NDFlOTMtNWJmMy00YTA1LTlkNTMtOWJkMjk4YTJkOWE5IiwicyI6Ik9XTXpZVEk1WkdNdE5HTXpOaTAwTURFd0xXSTNPRGt0WkdJeU1EUXdNalk0WXpVNCJ9
...
const NAME = process.env.NAME || 'fuyao';                        // 节点名称
